          ...
          <div className="container-fluid">
            <div className="row">
              <div className="col-md-3 part1">
                ...
                <p>
                  <LocationOnOutlinedIcon /> <strong>Address</strong>: 111 LPU
                ...
                <p>
                  <EmailOutlinedIcon /> <strong>Email:</strong> varun@gmail.com
                </p>
                <p>
            ...
            <div className="row lastStrip">
              <div className="col-md-3 part_1">
                <p>© 2024, HTML Ecommerce Template All rights reserved</p>
              </div>
                ...
                <div className="m-auto d-flex align-items-center phWrap">
                  <div className="phNo d-flex align-items-center mx-5">
                    ...
                    <div className="info ml-3">
                      <h3 className="text-g mb-0">+91 123456788</h3>
